...
// nestedFunction can access the variable internal because nestedFunction is the child to myFunction and a child can access their parent's scope. The closure happens when nestedFunction accesses the interal varaible in the outer scope. 
...
// function animalNames(array){
//   const newArr = [];
//   array.forEach(item => newArr.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`));
// return newArr;
// }
...
//   }
// }
// const cubeThree = new CubeMaker({
//   length: 7,
//   width: 7,
//   height: 7
// })
// console.log(cubeThree.volumeCube()); // 343
// console.log(cubeThree.surfaceAreaCube()); // 294
